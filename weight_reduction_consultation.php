...
<body>
	...
	<div id="body">
		<div class="footer">
			...
			<div>
				<a href="appointment_form.php"><img src="images/doctors.jpg" height="177px" width="298px" alt=""></a>
				<h3>book online</h3>
				<p>
					put some content.
				</p>
			...
			<div2>
				<a href="contact.php"><img src="images/where-you-can-find.jpg" height="177px" width="298px" alt=""></a>
				<h3>book over phone</h3>
				<p>
					put some content.
				</p>
			</div2>
