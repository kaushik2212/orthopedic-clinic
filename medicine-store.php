...
<head>
	<meta charset="UTF-8">
	<title>MEDICAL STORE | SERVICES | MAXKNEE</title>
	...
	<div id="body">
		<div id="content">
          ...
          <li class="selected">
			...
			<div id="section">
				<h2>medical store</h2>
				<img src="images/medicine_store.png" height="188px" width="188px" alt="physiotherapy">
				<p>
					Write something about medical store...
				</p>
			</div>
		</div>
	</div>
