...
<head>
	<meta charset="UTF-8">
	<title>PHYSIOTHERAPY | SERVICES | MAXKNEE</title>
	...
	<div id="body">
		<div id="content">
          ...
          <li>
			...
			<div id="section">
				<h2>physiotherapy</h2>
				<img src="images/physiotherapy.png" height="248px" width="248px" alt="physiotherapy">
				<p>
					Write something about physiotherpy...
				</p>
			</div>
		</div>
	</div>
